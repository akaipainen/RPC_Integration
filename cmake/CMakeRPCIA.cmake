...
# @DINCDIRS Include folders that need to be passed to cint/cling
...
macro(_generate_dictionary DNAME LDNAME DHDRS DHDRS_DEPS DINCDIRS)
    ...
    # Received as fourth optional argument
    ...
    if(ROOT_VERSION_MAJOR LESS 6)
        ...
        add_custom_command(
            OUTPUT 
                ${CMAKE_CURRENT_BINARY_DIR}/lib${DNAME}.rootmap ${CMAKE_CURRENT_BINARY_DIR}/G__${DNAME}.cxx ${CMAKE_CURRENT_BINARY_DIR}/G__${DNAME}_rdict.pcm
            COMMAND
...
# Generate the static dependencies from dynamic list
# @shared_list
# @static_list
macro(generator_static_dependencies shared_list static_list)
    set(static_list_tmp "")
...
endmacro(generator_static_dependencies)
